...
@Extension
public class ArtifactsUploader implements GoPlugin {

    public static final String ADDITIONAL_OPTIONS = "AdditionalOptions";
    static Logger logger = Logger.getLoggerFor(ArtifactsUploader.class);
    ...
    private GoPluginApiResponse handleTaskView() throws IOException {
        ...
        ArtifactsUploaderView oldView = new ArtifactsUploaderView();
    ...
    private GoPluginApiResponse handleTaskExecution(GoPluginApiRequest request) throws IOException {
        int responseCode = DefaultGoPluginApiResponse.SUCCESS_RESPONSE_CODE;
        ArtifactsUploaderExecutor executor = new ArtifactsUploaderExecutor();
